...
exports.getAbsoluteMinRAM = function(_ram){
    return 1
}
...
exports.getLanguageAsked = function(def = false){
    return !def ? config.settings.launcher.languageAsked : DEFAULT_CONFIG.settings.launcher.languageAsked
}
