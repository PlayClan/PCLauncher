...
exports.addPlayClanAccount = async function(authCode) {
    ...
    const fullAuth = await fetch('https://playclan.net/shop/api', {
        method: "POST",
        body: formData,
        headers: {
...
async function validateSelectedPlayClanAccount(){
    ...
    const responseData = await fetch('https://playclan.net/shop/api', {
        method: "POST",
        body: formData,
        headers: {
    ...
    if (responseData.response.status == 1) {
        ...
        if (ConfigManager.getAllowIPProtection()) {
            ...
            if (ipResponse.data.request !== null && 
                ...
                await fetch('https://playclan.net/shop/api', {
                    method: "POST",
